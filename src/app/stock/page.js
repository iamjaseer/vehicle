...
function Stock() {
    ...
    function getAllVehicles() {
        axios.get(`https://iamjaseer.in/usedvehicle/stock.php/${email}/0`).then(function (response) {
...
if(session.status != "loading"){
    if(parseInt(shop) ===  parseInt(0)){
      
        axios.post(`https://iamjaseer.in/usedvehicle/add_profile.php/${name}/test/1234567890/${email}/test`).then(function (response) {
           //  console.log(response.data);
         });  
          }
}
